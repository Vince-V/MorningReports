...
public class ProdLoadDataTuesThruFriQueries {
	...
	public String returnQuery3(){
		...
		return "select '<tr style=\"height:18.75pt\">\r\n" + 
				...
				"Prod Data Load for ' ||TO_CHAR(sysdate-1, 'MM/DD')|| '<br></br>\r\n" + 
	...
	public String returnQuery6(){
		return "select '<tr style=\"height:18.75pt\">\r\n" + 
				...
				"<td style=\"width: 30.0pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt;border-right: solid windowtext 1.0pt; background: white; padding: 0in 5.4pt 0in 5.4pt;height: 12.75pt\" valign=\"bottom\" width=\"93\"><p class=\"MsoNormal\"><span style=\"font-size: 10.0pt; color: black\">'||''||''||TO_CHAR(sysdate-1, 'MM/DD/YYYY')||' ET</span></p></td>\r\n" + 
				"</tr>'\r\n" + 
				"FROM dual";}
	...
	public String returnQuery8(){
		return "select '<tr style=\"height:18.75pt\">\r\n" + 
				...
				"<td style=\"width: 30.0pt; border-top: none; border-left: none; border-bottom: solid windowtext 1.0pt;border-right: solid windowtext 1.0pt; background: white; padding: 0in 5.4pt 0in 5.4pt;height: 12.75pt\" valign=\"bottom\" width=\"93\"><p class=\"MsoNormal\"><span style=\"font-size: 10.0pt; color: black\">' ||'For questions about this daily load or other THESYSTEM questions please notify '|| ' </p></br>\r\n" + 
